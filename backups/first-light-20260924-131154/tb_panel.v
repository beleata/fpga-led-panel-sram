...
module tb_panel;
    ...
    initial begin
        expected[0]=16'h0000; expected[1]=16'h020f;
    ...
    always @(posedge SCLK) begin
        ...
        if (old_state != dut.state) begin
            ...
            if (old_state == 9) begin
                if (clocks != 16384 || latch_count != 256)
                ...
                if (frames == 23) begin
                    ...
                    $display("PASS: 22 register words broadcast to all four chips; 23 full 16-bit frames; 256 latches/frame");
                    $finish;
                end
            end
        ...
        if (dut.state >= 3 && dut.state <= 7) begin
            if (LAT !== (clocks > 59)) $fatal(1,"Register latch window");
        ...
        if (dut.state == 9) begin
            if (LAT !== ((clocks % 64) == 0)) $fatal(1,"Grayscale latch interval");
