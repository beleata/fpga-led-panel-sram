...
## Active test: static mapping target
...
test is now ONE fixed image: white perimeter, yellow circle, white right arrow,
...
reference PNGs. The candidate mapping follows DMD pattern 3 for GKGD P5 1/8:
